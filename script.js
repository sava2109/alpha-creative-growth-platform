...
document.addEventListener("DOMContentLoaded", function () {
    var placeholderText = "This is some text inside of a div block.";
    var testimonialReplacement = "Alpha Creative brought structure, speed, and clear communication to our digital growth initiatives.";
    var textReplacements = new Map([
        [
            "As a company that embraces AI and supports its ethical use, our image was fully generated using ChatGPT.",
            "Our visual identity reflects a modern, digital-first brand focused on strategy, performance, and creativity."
        ],
        ["SAVA DA NAPISE CASE STUDY", "Case study available upon request."],
        ["SAVA DA NAPISE CASE STADY", "Case study available upon request."],
        [placeholderText, testimonialReplacement],
        ["hello@alphacretive.agency", "hello@alphacreative.agency"],
        ["Postgasse 8b, 1010 Vienna Autsria", "Postgasse 8b, 1010 Vienna, Austria"]
    ]);
    ...
    function getGitHubPagesBasePath() {
        ...
        return /\.[a-z0-9]+$/i.test(firstSegment) ? "" : "/" + firstSegment;
    }
    ...
    function replaceVisibleText(node) {
        if (node.nodeType === Node.TEXT_NODE) {
            ...
            textReplacements.forEach(function (replacement, search) {
        ...
        node.childNodes.forEach(replaceVisibleText);
    }

    function removePlaceholderBlocks() {
        document.querySelectorAll(".pricing-card-wrapper.milan, .section-2.milan").forEach(function (element) {
            element.remove();
        });
    }

    function fixContactDetails() {
        document.querySelectorAll('a[href="mailto:hello@alphacreativeagency.prmanagment.org"]').forEach(function (link) {
            link.setAttribute("href", "mailto:hello@alphacreative.agency");
            link.textContent = "hello@alphacreative.agency";
        });
    }
